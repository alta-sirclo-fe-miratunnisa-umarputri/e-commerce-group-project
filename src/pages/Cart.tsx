    ...
    return (
      <div>
        ...
        <div className="cart-main-container">
          <div className="cart-first-column m-2">Your cart is empty ..</div>
        ...
        <div className="cart-main-container">
          <div className="cart-first-column">
            {carts.map((item: any, index) => (
              <div key={index} className="card flex-row flex-wrap m-2">
                <div className="card-header border-0">
                  <img className="cart-image-sizing" src={Photo} alt="" />
                </div>
